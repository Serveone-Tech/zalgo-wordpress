          ...
          <div ref={founderRef.ref} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className={`relative rounded-3xl overflow-hidden border border-gray-700/60 bg-gray-900/60 backdrop-blur-sm shadow-2xl flex flex-col ${founderRef.inView ? "animate-slide-in-left" : "opacity-0"}`}>
              ...
              <div className="flex flex-col flex-1 p-8">
                ...
                <div className="mt-6 flex items-center gap-3">
                  ...
                  <a href="mailto:sales@zalgoinfotech.in" className="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl border border-gray-700 hover:border-teal-500/50 text-gray-300 hover:text-white font-semibold text-xs transition-all">
            ...
            <div className={`relative rounded-3xl overflow-hidden border border-gray-700/60 bg-gray-900/60 backdrop-blur-sm shadow-2xl flex flex-col ${founderRef.inView ? "animate-slide-in-right" : "opacity-0"}`}>
              ...
              <div className="flex flex-col flex-1 p-8">
                ...
                <div className="mt-6">
                  <a href="mailto:sales@zalgoinfotech.in" className="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl border border-gray-700 hover:border-blue-500/50 text-gray-300 hover:text-white font-semibold text-xs transition-all">
                    <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" /></svg>
                    Email
                  </a>
                </div>
            ...
            <div className={`relative rounded-3xl overflow-hidden border border-gray-700/60 bg-gray-900/60 backdrop-blur-sm shadow-2xl flex flex-col ${founderRef.inView ? "animate-fade-in-up" : "opacity-0"}`}>
              ...
              <div className="flex flex-col flex-1 p-8">
                ...
                <div className="mt-6">
                  <a href="mailto:sales@zalgoinfotech.in" className="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl border border-gray-700 hover:border-pink-500/50 text-gray-300 hover:text-white font-semibold text-xs transition-all">
                    <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" /></svg>
                    Email
                  </a>
                </div>
